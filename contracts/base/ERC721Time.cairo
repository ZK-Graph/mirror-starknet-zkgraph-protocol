...
from starkware.cairo.common.math import assert_not_zero, assert_nn, split_felt, assert_not_equal
...
@event
func Transfer(from_: felt, to: felt, token_id: Uint256):
end
...
# Mapping from token ID to token Data (owner address and mint timestamp)
@storage_var
func ERC721_token_data(token_id : Uint256) -> (res : DataTypes.TokenData):
end

# Mapping owner address to token count
@storage_var
func ERC721_balances(account: felt) -> (res : Uint256):
end
...
namespace ERC721Time:
    ...
    func owner_of{
        ...
        let (owner) = ERC721_token_data.read(token_id).owner
    ...
    func _exists{
        ...
        let (res) = ERC721_token_data.read(token_id).owner
