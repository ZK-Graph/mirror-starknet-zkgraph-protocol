...
namespace ERC721Enumerable {
    ...
    func total_supply{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> Uint256 {
    ...
    func token_by_index{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
        ...
        let is_lt : felt = uint256_lt(index, len);
    ...
    func _burn{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(token_id: Uint256) {
        let from_ : felt = ERC721.owner_of(token_id);
        _remove_token_from_owner_enumeration(from_, token_id);
...
func _remove_token_from_all_tokens_enumeration{
    ...
    let is_equal : felt = uint256_eq(last_token_index, token_index);
    if (is_equal == FALSE) {
...
func _remove_token_from_owner_enumeration{
    ...
    let last_token_index : Uint256 = SafeUint256.sub_le(last_token_index, Uint256(1, 0));
    ...
    let is_equal : felt = uint256_eq(token_index, last_token_index);
    if (is_equal == TRUE) {
